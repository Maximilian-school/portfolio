var Godot = (() => {
    ...
    return async function (moduleArg = {}) {
                ...
                getPositionWorklet() {
                    ...
                    if (GodotAudio.audioPositionWorkletNodes.length > 0) {
                        this._positionWorklet =
                            GodotAudio.audioPositionWorkletNodes.pop();
                    } else {
                    ...
                    const resetParameter =
                        this._positionWorklet.parameters.get("reset");
                    resetParameter.setValueAtTime(
                        1,
                        GodotAudio.ctx.currentTime
                    );
                    resetParameter.setValueAtTime(
                        0,
                        GodotAudio.ctx.currentTime + 1
                    );
                    return this._positionWorklet;
                }
                clear() {
        ...
        function _godot_js_rtc_pc_remote_description_set(
            ...
            ref.setRemoteDescription({ sdp, type })
                .then(function () {
                    if (type !== "offer") {
                        return Promise.resolve();
                    }
        ...
        function assignWasmExports(wasmExports) {
            ...
            Module["_main"] = _main = createExportWrapper(
                "__main_argc_argv",
                2
            );
