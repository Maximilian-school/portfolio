        ...
        <div className="flex flex-wrap justify-center p-4 gap-2">
            {languages.map(([name, Icon, url]) => (
                <a
                    href={url}
                    key={name}
                    className="text-lg mb-2 flex items-center gap-2 text-[#ededed] bg-blue-800 p-2 rounded-full border-2 border-blue-700 hover:translate-y-2 transition cursor-pointer"
                >
