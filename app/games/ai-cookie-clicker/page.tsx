...
export default function ClickerGame() {
            ...
            try {
                ...
                if (timePassed > 0 && timePassed < 86400) {
                    ...
                    const offlineEarnings = Math.floor(
                        timePassed * offlineCps * offlineMultiplier
                    );
                    ...
                    if (offlineEarnings > 0) {
                        ...
                        setTimeout(() => {
                            alert(
                                `Welcome back! You earned ${offlineEarnings.toLocaleString()} cookies while you were away!`
                            );
                        }, 100);
                    }
                }
    ...
    const buyUpgrade = (type: UpgradeType) => {
        const costs: Record<UpgradeType, number> = {
            ...
            productionMultiplier: Math.floor(
                10000 * 5 ** (productionMultiplier - 1)
            ),
        };
        ...
        if (cookies >= costs[type]) {
            ...
            switch (type) {
                ...
                case "factory":
                    ...
                    break;
                case "megaFactory":
                    setMegaFactories((prev) => prev + 1);
                    break;
                case "lab":
                    setLabs((prev) => prev + 1);
                    break;
                case "portal":
                    setPortals((prev) => prev + 1);
                    break;
                case "timeMachine":
                    setTimeMachines((prev) => prev + 1);
                    break;
                case "clickMultiplier":
                    setClickMultiplier((prev) => prev + 1);
                    break;
                case "productionMultiplier":
                    setProductionMultiplier((prev) => prev + 1);
                    break;
            }
        }
    };
    ...
    const resetGame = () => {
        if (
            window.confirm("Are you sure? This will delete all your progress!")
        ) {
            ...
            <div className="max-w-6xl mx-auto">
                <div className="flex justify-between items-center mb-4">
                    <h1 className="text-4xl font-bold text-amber-900">
                        🍪 Cookie Clicker ripoff from Claude + ChatGPT 🍪
                    </h1>
                    <button
                        onClick={resetGame}
                    ...
                    <div className="bg-white rounded-2xl shadow-xl p-8 flex flex-col items-center">
                        <div className="text-center mb-6">
                            ...
                            <div className="text-xs text-gray-500 mt-1">
                                Total baked:{" "}
                                {Math.floor(totalCookies).toLocaleString()}
                            </div>
                        </div>
                        ...
                        <div className="relative mb-6">
                            ...
                            >
                                <FaCookieBite
                                    size={200}
                                    className="text-amber-600 drop-shadow-2xl cursor-pointer"
                                />
                            </button>
                        ...
                        <div className="text-center text-gray-600">
                            ...
                            <div className="text-sm text-gray-500">
                                = {Math.floor(clickPower * clickMultiplier)} per
                                click
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="space-y-3">
                            {[
                                ...
                                },
                                {
                                    ...
                                    desc: "x2 CPS",
                                    owned: productionMultiplier,
                                },
                            ].map((u) => {
                                const Icon = u.icon;
                                const cost = getCost(
                                    u.type as UpgradeType,
                                    u.owned
                                );
                                return (
                                    <button
                                        key={u.type}
                                        onClick={() =>
                                            buyUpgrade(u.type as UpgradeType)
                                        }
