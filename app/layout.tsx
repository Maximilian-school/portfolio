...
export const metadata: Metadata = {
    ...
    description:
        "My awesome website where I rant about stuff, make games, or when downloading more RAM rickro- *Cough what?",
};
    ...
    return (
        <html lang="en">
            ...
            >
                <Analytics />
                <nav
                    className="bg-neutral-primary fixed w-full z-20 top-0 left-0 border-b border-gray-600 bg-gray-700"
                    id="topBar"
                >
                        ...
                        >
                            <ul className="font-medium flex flex-col p-4 md:p-0 mt-4 border border-gray-600 rounded-md bg-gray-800 md:flex-row md:space-x-8 md:mt-0 md:border-0 md:bg-transparent">
                                <li>
                                    <Link
                                        href="/"
                                        className="flex items-center gap-1 py-2 px-3 font-bold text-white bg-brand rounded md:bg-transparent md:text-fg-brand md:p-0"
                                    >
