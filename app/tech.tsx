...
import { SiFastapi, SiFirebase, SiFlask, SiGodotengine, SiRender, SiRobloxstudio, SiSupabase, SiUnity, SiVercel } from "react-icons/si"
  ...
  return (
    <div className="flex flex-wrap justify-center p-4 gap-2">
      {technologies.map(([name, Icon, url]) => (
        <a href={url} key={name} className="text-lg mt-2 flex items-center gap-2 text-[#ededed] bg-red-800 p-2 rounded-full border-2 border-red-700 hover:translate-y-2 transition cursor-pointer">
